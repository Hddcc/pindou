...
3. 在分享菜单中向下找“添加到主屏幕”，名称可以保留“老派拼豆之必要”，点击“添加”。
...
3. 从应用切换器关闭老派拼豆之必要，再点击主屏幕图标重新打开。
...
- 更新主屏幕名称与图标：已有入口可能保留安装时的名称和图片。先下载重要作品的 `.pindou` 文件或保存云端，再在 Safari 中联网刷新更新后的网址并添加新的主屏幕入口，确认名称和图片。检查新入口能打开并恢复作品，必要时导入文件，再自行移除旧入口；避免未备份就删除旧应用或清理网站数据。用户可以自行修改主屏幕名称，应用无法强制更改已有名称。
